...
import 'package:talab/features/wallet/presentation/view/deposit_sucess.dart';
...
class AddMoneyView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddMoneyView> createState() => _AddMoneyViewState();
}
                  ...
                  : currentUser != null
                      ? Column(
                          ...
                          children: [
                            ...
                            // Container(
                            //   padding: EdgeInsets.all(16),
                            //   color: AppColorConstant.black87,
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 105),
                                      SliderButton(
                                        text: "Slide to deposit",
                                        onSlided: () async {
                                          double addedAmount = double.tryParse(
                                                  _controller.text) ??
                                              0.0;
