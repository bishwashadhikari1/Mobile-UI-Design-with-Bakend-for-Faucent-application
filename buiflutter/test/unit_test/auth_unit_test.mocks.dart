...
// in talab/test/unit_test/auth_unit_test.dart.
...
import 'package:talab/core/failure/failure.dart' as _i7;
import 'package:talab/features/auth/domain/entity/user_entity.dart' as _i9;
import 'package:talab/features/auth/domain/use_case/auth_usecase.dart' as _i5;
...
class MockAuthUseCase extends _i1.Mock implements _i5.AuthUseCase {
  @override
  _i6.Future<_i2.Either<_i7.Failure, String>> uploadProfileProfile(
          _i8.File? file) =>
      (super.noSuchMethod(
        Invocation.method(
          #uploadProfileProfile,
          [file],
        ),
  ...
  @override
  _i6.Future<_i2.Either<_i7.Failure, _i9.UserEntity>> loginStudent(
    String? username,
    String? password,
  ) =>
      (super.noSuchMethod(
